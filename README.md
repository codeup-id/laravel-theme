...
'providers' => [
	...
	LaravelUP\Theme\ThemeServiceProvider::class,
...
'aliases' => [
	...
	'Theme' => LaravelUP\Theme\Facades\Theme::class,
...
~~~
php artisan vendor:publish --provider="LaravelUP\Theme\ThemeServiceProvider"
~~~
...
## Using theme global
~~~php
use LaravelUP\Theme\Contracts\Theme;
...
protected $routeMiddleware = [
    ...
    'setTheme' => \LaravelUP\Theme\Middleware\ThemeLoader::class,
];
~~~
