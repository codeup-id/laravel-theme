...
use LaravelUP\Theme\Contracts\Theme as ThemeContract;
use LaravelUP\Theme\Manifest;
...
class Theme implements ThemeContract
{
     ...
     * @param  \LaravelUP\Theme\asset $asset
     * @param  \Illuminate\Filesystem\Filesystem $files
     * @param  \LaravelUP\Breadcrumb|\LaravelUP\Theme\Breadcrumb $breadcrumb
     * @param  \LaravelUP\Theme\Manifest $manifest
     *
     * @return \LaravelUP\Theme\Theme
     */
...
//        $this->layout($this->getConfig('layoutDefault'));
     ...
     *
     * @return \LaravelUP\Theme\Breadcrumb
     */
